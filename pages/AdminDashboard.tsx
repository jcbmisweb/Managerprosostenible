            ...
            <div className="bg-white rounded-[2rem] border border-slate-100 p-8 shadow-sm">
              ...
              <form onSubmit={handleCreateClassroom} className="flex flex-col sm:flex-row gap-3">
                ...
                <button
                  ...
                  className="bg-slate-900 text-white hover:bg-slate-800 px-6 py-3 rounded-xl font-bold text-xs uppercase tracking-widest flex items-center gap-2 transition-all disabled:opacity-50"
                >
                  <Plus size={16} />
                  Crear Aula
                </button>
